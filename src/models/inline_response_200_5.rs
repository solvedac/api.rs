...
/// InlineResponse2005 : 페이지네이션 가능한 쿼리의 응답 결과입니다.
...
pub struct InlineResponse2005 {
    ...
    /// 현재 페이지의 원소 목록입니다.
    #[serde(rename = "items")]
    pub items: Vec<crate::models::GetUserProblemTagStatsProblemTagStat>,
}

impl InlineResponse2005 {
    /// 페이지네이션 가능한 쿼리의 응답 결과입니다.
    pub fn new(count: i32, items: Vec<crate::models::GetUserProblemTagStatsProblemTagStat>) -> InlineResponse2005 {
        InlineResponse2005 {
            count,
            items,
        }
