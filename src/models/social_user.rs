...
/// SocialUser : solved.ac 사용자 정보입니다.
...
pub struct SocialUser {
    ...
    #[serde(rename = "reverseBlocked")]
    pub reverse_blocked: bool,
    /// 사용자명입니다.
    #[serde(rename = "handle")]
    pub handle: String,
    /// 자기소개입니다.
