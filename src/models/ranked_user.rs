...
impl RankedUser {
    /// 사용자 정보입니다. 
    pub fn new(handle: String, bio: String, background_id: String, profile_image_url: Option<String>, solved_count: i64, vote_count: i64, exp: i64, tier: i64, rating: i64, rating_by_problems_sum: i64, rating_by_class: i64, rating_by_solved_count: i64, rating_by_vote_count: i64, class: i64, class_decoration: crate::models::ClassDecoration, rival_count: i64, reverse_rival_count: i64, max_streak: i64, coins: i64, stardusts: i64, joined_at: String, banned_until: String, pro_until: String, rank: i64) -> RankedUser {
        RankedUser {
            handle,
            bio,
            badge_id: None,
