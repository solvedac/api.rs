...
pub struct GetUserContributionStatsContributionStat {
    ...
    pub solved: i32,
    /// 사용자가 푼 표준 문제 수입니다.
    #[serde(rename = "solvedStandards")]
    pub solved_standards: i32,
    /// 사용자가 기여한 문제 수입니다.
    #[serde(rename = "contributed")]
    pub contributed: i32,
}

impl GetUserContributionStatsContributionStat {
    pub fn new(total: i32, solved: i32, solved_standards: i32, contributed: i32) -> GetUserContributionStatsContributionStat {
