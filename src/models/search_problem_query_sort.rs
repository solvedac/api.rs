...
/// SearchProblemQuerySort : 검색 결과 정렬 기준

/// 검색 결과 정렬 기준
#[derive(Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Serialize, Deserialize)]
pub enum SearchProblemQuerySort {
    #[serde(rename = "id")]
    Id,
    #[serde(rename = "level")]
    Level,
...
impl ToString for SearchProblemQuerySort {
    fn to_string(&self) -> String {
        match self {
            Self::Id => String::from("id"),
            Self::Level => String::from("level"),
            Self::Title => String::from("title"),
            Self::Solved => String::from("solved"),
            Self::AverageTry => String::from("average_try"),
