...
/// Organization : solved.ac에 등록한 단체입니다.
...
impl Organization {
    ...
    pub fn new(organization_id: i32, name: String, _type: crate::models::OrganizationType, rating: i32, user_count: i32, vote_count: i32, solved_count: i32, color: String) -> Organization {
        Organization {
            organization_id,
            name,
            _type: Box::new(_type),
