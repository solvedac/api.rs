...
pub struct GetProblemsCountGroupByLevelLevelEntry {
    #[serde(rename = "level")]
...
impl GetProblemsCountGroupByLevelLevelEntry {
    pub fn new(level: crate::models::ProblemLevel, count: i32) -> GetProblemsCountGroupByLevelLevelEntry {
