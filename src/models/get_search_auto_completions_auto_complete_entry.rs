...
/// GetSearchAutoCompletionsAutoCompleteEntry : 고급 검색 관련 자동 완성입니다.



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct GetSearchAutoCompletionsAutoCompleteEntry {
...
impl GetSearchAutoCompletionsAutoCompleteEntry {
    /// 고급 검색 관련 자동 완성입니다.
    pub fn new(caption: String, description: String) -> GetSearchAutoCompletionsAutoCompleteEntry {
        GetSearchAutoCompletionsAutoCompleteEntry {
            caption,
            description,
        }
    }
