...
/// GetSearchAutoCompletionsBriefProblemEntry : 요악한 문제 정보입니다.



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct GetSearchAutoCompletionsBriefProblemEntry {
    /// 문제 ID입니다.
    #[serde(rename = "id")]
    pub id: i32,
    /// 문제 제목입니다.
    ...
    pub title: String,
    #[serde(rename = "level")]
    pub level: Box<crate::models::ProblemLevel>,
    /// 푼 사람 수입니다.
    #[serde(rename = "solved")]
    pub solved: i32,
...
impl GetSearchAutoCompletionsBriefProblemEntry {
    /// 요악한 문제 정보입니다.
    pub fn new(id: i32, title: String, level: crate::models::ProblemLevel, solved: i32, caption: String, description: String) -> GetSearchAutoCompletionsBriefProblemEntry {
        GetSearchAutoCompletionsBriefProblemEntry {
            id,
            title,
            level: Box::new(level),
            solved,
