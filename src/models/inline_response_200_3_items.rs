...
/// InlineResponse2003Items : 페이지네이션 가능한 쿼리의 응답 결과입니다.



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct InlineResponse2003Items {
    /// ID입니다.
...
impl InlineResponse2003Items {
    /// 페이지네이션 가능한 쿼리의 응답 결과입니다.
    pub fn new(organization_id: i32, name: String, _type: crate::models::OrganizationType, rating: i32, user_count: i32, vote_count: i32, solved_count: i32, color: String, rank: i32) -> InlineResponse2003Items {
