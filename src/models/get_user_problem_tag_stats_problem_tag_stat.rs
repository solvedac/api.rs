...
pub struct GetUserProblemTagStatsProblemTagStat {
    #[serde(rename = "tag")]
    pub tag: Box<crate::models::ProblemTag>,
...
impl GetUserProblemTagStatsProblemTagStat {
    pub fn new(tag: crate::models::ProblemTag, total: i32, solved: i32, partial: i32, tried: i32) -> GetUserProblemTagStatsProblemTagStat {
        GetUserProblemTagStatsProblemTagStat {
            tag: Box::new(tag),
            total,
            solved,
            partial,
