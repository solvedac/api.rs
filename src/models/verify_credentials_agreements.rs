...
/// VerifyCredentialsAgreements : 사용자 동의 여부입니다.



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct VerifyCredentialsAgreements {
    /// 동의한 약관 버전입니다.
    #[serde(rename = "tos")]
    pub tos: String,
    /// 동의한 개인정보 처리방침 버전입니다.
...
impl VerifyCredentialsAgreements {
    /// 사용자 동의 여부입니다.
    pub fn new(tos: String, privacy: String) -> VerifyCredentialsAgreements {
        VerifyCredentialsAgreements {
            tos,
            privacy,
        }
    }
