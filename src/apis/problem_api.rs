...
pub async fn get_class_problem_count(configuration: &configuration::Configuration, ) -> Result<Vec<crate::models::InlineResponse2002>, Error<GetClassProblemCountError>> {
...
pub async fn get_problem_level(configuration: &configuration::Configuration, ) -> Result<Vec<crate::models::InlineResponse2003>, Error<GetProblemLevelError>> {
