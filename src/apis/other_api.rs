...
/// struct for typed errors of method `get_site_statistics`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetSiteStatisticsError {
    UnknownValue(serde_json::Value),
}


/// solved.ac 통계를 가져옵니다.
pub async fn get_site_statistics(configuration: &configuration::Configuration, ) -> Result<crate::models::SiteStatistics, Error<GetSiteStatisticsError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetSiteStatisticsError> = serde_json::from_str(&local_var_content).ok();
